...
const Header = () => {
    ...
    return (
        <header className={`flex items-center w-full p-4 h-[10vh] justify-between xl:justify-start z-50 bg-gradient-to-l from-sky-950 md:from-50% from-30% to-sky-100 sticky ${scrollDirection === "down" ? "-top-[10vh]" : "top-0"} top-0 transition-all duration-500`}>
            <img src={logo} alt="Logo" className="h-full ml-12" />
